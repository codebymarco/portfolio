  ...
  return (
    <div className="blog-page">
      <div className="blog-header">
        <h1>BLOG</h1>
        <p>Insights and tutorials on web development, DevOps, and modern technologies</p>
      </div>
      ...
      <div className="blog-tags-filter">
        ...
        <div className="blog-tags-list">
          {popularTags.map((tag) => (
            <button
              key={tag.name}
              className={`blog-tag-button ${selectedTags.includes(tag.name) ? 'active' : ''}`}
            ...
            >
              ...
              <div className="blog-card-content">
                ...
                <div className="blog-card-tags">
                  ...
                  {blog.tags.length > 3 && (
                    <span className="blog-card-tag-more">+{blog.tags.length - 3}</span>
                  )}
                </div>
