    ...
    <div className="appWrapper">
      <div className="container">
        <div className="app-nav">
          <Link to="/apps" className="app-breadcrumb">apps / linkbio</Link>
        </div>
        ...
        <div className="app-container">
          ...
          >
            <img src={img} alt="LinkBio project screenshot" className="project-image" />
          </motion.div>
          ...
          >
            <motion.div className="app-details-box" variants={itemVariants}>
              ...
              <p className="description-text">
                <span className="highlight">LINKBIO</span> is a
