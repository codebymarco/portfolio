    ...
    <div className="appWrapper">
      <div className="container">
        <div className="app-nav">
          <Link to="/apps" className="app-breadcrumb">apps / formio</Link>
        </div>
        ...
        <div className="app-container">
          ...
          >
            <img src={img} alt="Formio project screenshot" className="project-image" />
          </motion.div>
          ...
          >
            <motion.div className="app-details-box" variants={itemVariants}>
              ...
              <p className="description-text">
                <span className="highlight">FORMIO</span> is a powerful
